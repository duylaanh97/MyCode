    ...
    ngOnInit() {
        this.model = [
            {label: 'Trang chủ', icon: 'dashboard', routerLink: ['/']},
            {
                ...
                items: [
                    {label: 'Dịch vụ', icon: 'subject', routerLink: ['/clinic-service']}
                ]
            },
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    {label: 'Hồ sơ bệnh nhân', icon: 'subject', routerLink: ['/treatment/customer-profile']}
                ]
            },
            {
                label: 'Quản lý thanh toán', icon: 'menu',
                items: [
                    {label: 'Empty Page', icon: 'subject', routerLink: ['/empty']}
                ]
            },
            {
