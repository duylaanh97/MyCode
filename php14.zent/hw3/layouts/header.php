            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="users.php"><i class="fa fa-dashboard fa-fw"></i> Quản Lý Người Dùng </a>
                        </li>
                        <li>
                            <a href="posts.php"><i class="fa fa-dashboard fa-fw"></i> Quản Lý Bài Viết </a>
                        </li>
                        <li>
                            <a href="Tags.php"><i class="fa fa-dashboard fa-fw"></i> Quản Lý Tags </a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
